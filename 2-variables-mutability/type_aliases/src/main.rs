...
fn main() {
    ...
    // Using the (Meters) type alias makes the code more readable and self-explanatory, as it clearly indicates that these variables represent lengths in meters.
